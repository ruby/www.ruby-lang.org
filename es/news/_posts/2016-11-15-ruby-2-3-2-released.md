...
Ruby 2.3.2 ha sido liberado.

Esta es la versión TEENY de la serie estable 2.3.

Este lanzamiento contiene la actualización de RubyGems 2.5.2 y actualización de los
certificados ssl incluídos.

También hay varias correciones de errores.
Ve el [ChangeLog](https://git.ruby-lang.org/ruby.git/plain/ChangeLog?id=refs/tags/v2_3_2)
...
Varios autores, desarrolladores y usuarios que reportaron errores ayudaron a crear este lanzamiento.
