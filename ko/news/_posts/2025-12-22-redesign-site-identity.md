...
이번 업데이트의 일환으로, 사이트의 아이덴티티를 "사람이 모이는 언어, 사람이 보이는 사이트"로 재설계했습니다.
...
또한 커뮤니티 구성원들과의 인터뷰와 사진을 포함하여, 프로그래밍 언어 뒤에 있는 많은 사람들의 존재를 느낄 수 있는 사이트로 만들었습니다.

새로운 디자인을 적용한 사이트 전체 업데이트는 아직 진행 중입니다. 깨진 링크와 일관성 문제 등 개선할 부분이 아직 많이 남아 있습니다. 여러분의 피드백을 기다리겠습니다.
