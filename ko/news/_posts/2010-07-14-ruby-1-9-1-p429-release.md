...
* Ruby 1.9.1 p378 및 그 이전의 모든 버전
* Ruby 1.9.2 preview3 및 그 이전의 모든 버전
* Ruby 1.9 개발 버전(1.9.3 dev)

각각에서 발생할 수 있습니다.

저희는 문제 발생을 최소화하기 위해 Ruby 1.9의 경우, 최신 버전인 1.9.1-p429나 1.9.2-rc1으로
업데이트하기를 권장합니다. 이 취약점은 Ruby 1.8 버전에 대해서는 직접적인 영향을 주지 않습니다.
