...
많은 사람들이 현업이나 취미로 일상적으로 를 사용하고 있습니다.
여기에 참고로 실생활에서 를 사용하고 있는 예를 모아 보았습니다.
{: .summary}

#### 시뮬레이션

* [NASA Langley Research Center][1]에서는 를 지휘 시뮬레이션에
  사용하고 있습니다.

* [Motorola][2]의 연구 그룹에서는 를 시나리오를 생성하고 데이터의
  처리를 저장하는 시뮬레이터를 작성하는 곳에 사용합니다.

#### 3D 모델링

* [Google SketchUp][3]은 를 마이크로 스크립팅 API로 사용한
  3D 모델링 애플리케이션입니다.

#### 비지니스

* [Toronto Rehab][4]은 IT 헬프 데스크 IT 오퍼레이션의 전화, 웹 고객지원을
  관리하고 추적하는데  웹 다이얼로그 기반의 애플리케이션을 사용합니다.

#### 로봇공학

* MORPHA 프로젝트에서는, 는 Siemens 서비스 로봇의 반응 컨트롤
  부분에 사용되고 있습니다.

#### 전화

* 는 3G 무선 전화 제품인 Lucent에서도 사용됩니다.

#### 시스템 관리

* 는 전 세계에 흩어져 있는 1700대의 UNIX (Solaris와 Linux) 서버에서
...
* [A List Apart][11]는 1997년부터 발행된 웹 사이트를 만드는 사람들을 위한
  메거진입니다. 최근에  온 Rails로 만들어진 독자적인 애플리케이션으로
  리뉴얼하였습니다.
