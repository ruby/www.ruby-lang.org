...
객체 변수는 객체 안에 숨겨져 있습니다. 사실 객체 변수가 그렇게 꽁꽁 숨겨져 있는 것은 아니지만, 는 기본적으로 데이터를
...
는 객체 변수를 접근하게 해주는 편리한 방법을 제공하고 있습니다.
...
에서는 클래스를 언제나 열어서 정의를 변경할 수 있습니다.
...
이번에는 IRB  인터랙티브 해석기를 사용하는 대신에 파일에 코드를 작성해봅시다.
