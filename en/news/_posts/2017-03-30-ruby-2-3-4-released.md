...
It is the accidentally removal of an API named `rb_thread_fd_close`.
We will fix this problem at the next release, but if you are faced with
the problem now and have to overcome it immediately, use this patch:
