...
Ruby 2.5.2 版本發佈時遺漏了一些構建必需之文件。詳見 [[漏洞 #15232]](https://bugs.ruby-lang.org/issues/15232)。

此發佈僅修復包缺失問題，並未修復任何 2.5.2 以來的其它問題。
