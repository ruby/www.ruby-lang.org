...
此次發佈包含修復一個在多執行緒/多進程（使用 `Process.fork`）應用程式的死結漏洞，比如說 Puma。

詳細的變動請參閱[提交紀錄](https://github.com/ruby/ruby/compare/v2_5_4...v2_5_5)。
...
我想對 sorah 和 k0kubun 的回報和研究致上最高的謝意。謝謝你們。
