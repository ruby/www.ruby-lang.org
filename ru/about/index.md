...
<sup>2</sup> Дополнительная информация на домашней странице [Ruby on Rails][ror].
{: #fn2}

<sup>3</sup> Matz, в [Интервью с Создателем Ruby][linuxdevcenter], 29 ноября 2001
года.
{: #fn3}

<sup>4</sup> Matz, в [Блоки и Замыкания в Ruby][artima], 22 декабря 2003
года.
{: #fn4}
