...
Подробности можно узнать из [списка изменений](http://svn.ruby-lang.org/repos/ruby/tags/v2_2_5/ChangeLog).
...
Начиная с этого релиза, ответственным за ветку Ruby 2.2 будет не nagachika-san, а usa.
Почти две трети изменений, включенных в этот релиз, были сделаны nagachika-san.
Спасибо за его огромный вклад.

Поддержка Ruby 2.2, включая этот релиз,
основана на "Соглашении о стабильной версии Ruby" от
[Ассоциации Ruby](http://www.ruby.or.jp/).
