...
Foi lançado o Ruby 2.6.1.

## Alterações

* [Net::Protocol::BufferedIO#write lança NoMethodError quando enviando uma string grande multi-byte](https://bugs.ruby-lang.org/issues/15468) has been fixed.

Esta versão inclui correções de bugs adicionais. Veja os [commit logs](https://github.com/ruby/ruby/compare/v2_6_0...v2_6_1) para mais detalhes.
...
Muitos commiters, pessoas desenvolvedoras e usuários que forneceram relatórios de bugs nos
ajudaram a fazer esta versão.
