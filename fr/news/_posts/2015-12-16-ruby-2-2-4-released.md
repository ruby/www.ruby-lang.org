---
layout: news_post
title: "Ruby 2.2.4 est disponible"
author: "nagachika"
...
`libffi`) et l'[API `DL`](http://ruby-doc.org/stdlib-2.2.4/libdoc/dl/rdoc/DL.html).
...
[ChangeLog](https://git.ruby-lang.org/ruby.git/plain/ChangeLog?id=refs/tags/v2_2_4)).
...
Merci à toutes les personnes (développeurs et utilisateurs) ayant participé à la
préparation de cette *release*, notamment à travers la remontée de bugs.
