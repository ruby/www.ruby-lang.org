---
layout: news_post
title: "Ruby 2.0.0-p648 est disponible"
author: "usa"
...
Cette nouvelle version comporte un correctif de sécurité pour `Fiddle` (*wrapper*
`libffi`) et plus précisement [l'API `DL`](http://ruby-doc.org/stdlib-2.0.0/libdoc/dl/rdoc/DL.html).
...
Ruby 2.0.0 entre en phase de maintenance de sécurité, jusqu'au 24 février 2016,
après quoi la branche 2.0 reviendra à la normale. Nous vous suggérons de passer
à une version plus récente de Ruby, telles que la 2.1, la 2.2 ou la toute
proche 2.3.
