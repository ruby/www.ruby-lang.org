---
layout: news_post
title: "Ruby 2.0.0-p647 est disponible"
author: "usa"
...
Nous avons le plaisir d'annoncer la sortie de Ruby 2.0.0-p647.
...
Et cette version inclut également un correctif pour une régression de lib/resolv.rb

* [Uninitialized constant bug introduced by typo in backport of [#10712]](https://bugs.ruby-lang.org/issues/11204)

Ruby 2.0.0 est désormais en phase de maintenance de sécurité jusqu'au 24 février 2016.
Après cette date, Ruby 2.0.0 ne sera plus maintenu.
Nous vous recommandons de démarrer le processus de migration vers une version de
Ruby plus récente, comme la version 2.1 ou 2.2.
...
Merci à tous ceux qui ont contribué à cette version, et plus particulièrement: hsbt.
