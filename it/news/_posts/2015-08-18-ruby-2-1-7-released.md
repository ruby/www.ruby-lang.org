...
E' stato rilasciato Ruby 2.1.7.

Questa release include un fix di sicurezza inerente una vulnerabilità sul
dominio di RubyGems.
Vedere il topic qui sotto per maggiori dettagli.
...
Sono inclusi anche molti altri fix.
Guarda i [ticket](https://bugs.ruby-lang.org/projects/ruby-21/issues?set_filter=1&amp;status_id=5)
e il [ChangeLog](http://svn.ruby-lang.org/repos/ruby/tags/v2_1_7/ChangeLog)
...
in particolare, nagachika.

La manutenzione di Ruby 2.1, che include questa release, segue
"Agreement for the Ruby stable version" della [Ruby Association](http://www.ruby.or.jp/).
