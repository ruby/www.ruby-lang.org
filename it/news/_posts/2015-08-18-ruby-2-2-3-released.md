...
Questa release include un fix di sicurezza riguardante una vulnerabilità
al dominio RubyGems.
...
Ci sono anche altri fix.
Vedi il [ChangeLog](http://svn.ruby-lang.org/repos/ruby/tags/v2_2_3/ChangeLog)
...
Tanti committer, sviluppatori e utenti che hanno riportato bug ci hanno
aiutato a fare questa release. Li ringrazio per il loro contributo.
