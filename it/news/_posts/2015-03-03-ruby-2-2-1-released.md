...
Questa è la prima `TEENY` release stabile della serie 2.2.

Questa release include il fix per il fallimento della build di ffi e il fix
ad un memory leak nel Symbol GC (Vedere [Bug #10686](https://bugs.ruby-lang.org/issues/10686)).

Vedere il [ChangeLog](http://svn.ruby-lang.org/repos/ruby/tags/v2_2_1/ChangeLog)
per i dettagli.
...
Molti committers, sviluppatori e utenti che hanno riportato bugs ci hanno
aiutato a realizzare questa release.
