...
Questa release contiene molti bugfixes, si veda il [ChangeLog](https://git.ruby-lang.org/ruby.git/plain/ChangeLog?id=refs/tags/v2_2_5)
per i dettagli.
...
Grazie a tutti coloro che hanno aiutato questo rilascio.

Con questa release il maintainer di Ruby 2.2 cambia da nagachika-san a usa.
Circa due terzi delle modifiche incluse in questa release sono stati fatti da
nagachika-san.
Un ringraziamento per il suo grande contributo.

La manutenzione di Ruby 2.2, inclusa questa release, è basato sull' "Agreement
