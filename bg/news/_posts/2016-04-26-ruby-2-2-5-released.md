...
[Списък с промени](http://svn.ruby-lang.org/repos/ruby/tags/v2_2_5/ChangeLog)
...
От този рилийз maintainer-ът на Ruby 2.2 става usa, който ще замести
nagichka-san.  Около две трети от промените в тази версия са направени от nagichka-san.
Благодарим му за неговият огромен принос към проекта.

Поддръжката на Ruby 2.2, включително този рилийз, е базирана на
