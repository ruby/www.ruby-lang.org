---
layout: news_post
title: "Ruby 2.7.0-rc2 Yayınlandı"
author: "naruse"
...
* Bazı standart kütüphaneler güncellendi.
  * Bundler 2.1.0.pre.3
    ([Geçmiş](https://github.com/bundler/bundler/blob/2-1-stable/CHANGELOG.md#210pre3-november-8-2019))
  * RubyGems 3.1.0.pre.3
    ([Geçmiş](https://github.com/rubygems/rubygems/blob/3.1/History.txt))
  * CSV 3.1.2
...
Daha fazla ayrıntı için [NEWS](https://github.com/ruby/ruby/blob/v2_7_0_rc2/NEWS)'e ya da [işleme günlükleri](https://github.com/ruby/ruby/compare/v2_6_0...v2_7_0_rc2)ne bakın.

Bu değişiklikler ile birlikte Ruby 2.6.0'dan bu yana [{{ release.stats.files_changed }} dosya değişti, {{ release.stats.insertions }} ekleme(+), {{ release.stats.deletions }} silme(-)](https://github.com/ruby/ruby/compare/v2_6_0...v2_7_0_rc2) yapıldı!
