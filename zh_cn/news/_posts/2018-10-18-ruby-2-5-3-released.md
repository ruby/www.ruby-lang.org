...
Ruby 2.5.2 版本发布时遗漏了一些构建必需的文件。详见 [[漏洞 #15232]](https://bugs.ruby-lang.org/issues/15232)。

此发布仅修复包缺失问题，并未修复任何 2.5.2 以来的其它漏洞。
