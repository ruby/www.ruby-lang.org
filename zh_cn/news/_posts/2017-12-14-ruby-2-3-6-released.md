...
此次发布相较于前个版本修复了约 10 个漏洞，包括数个安全问题的修复。请查询以下文章以获取详细信息。
...
查看 [ChangeLog](https://git.ruby-lang.org/ruby.git/plain/ChangeLog?id=refs/tags/v2_3_6) 以获取详情。
...
Ruby 2.3，包括这个版本，是基于 Ruby 协会的「Ruby 稳定版本协议」进行维护的。
