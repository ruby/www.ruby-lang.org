...
* 修复了[当 Net::Protocol::BufferedIO#write 传入过大的多字节字符串时会导致 NoMethodError](https://bugs.ruby-lang.org/issues/15468) 的错误。

此次发布修复了多个错误，请查看 [提交日志](https://github.com/ruby/ruby/compare/v2_4_4...v2_4_5) 以获取更多详情。
