...
バージョン 2.5.2 のパッケージファイルにはパッケージングのミスによりビルドに必要ないくつかのファイルが含まれていませんでした。
2.5.2 のパッケージの問題についての詳細は [[Bug #15232]](https://bugs.ruby-lang.org/issues/15232) を参照してください。
...
特に 2.5.2 のパッケージの問題を報告して頂いた wanabe さんに感謝致します。
