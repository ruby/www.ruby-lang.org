...
Ruby 3.4.5 がリリースされました。

このリリースはバグ修正と GCC 15 のサポートを含む定期的なアップデートです。詳しくは [release notes on GitHub](https://github.com/ruby/ruby/releases/tag/v3_4_5) を参照してください。

## リリーススケジュール

最新の安定版 Ruby (現在は Ruby 3.4) を最新のリリースから2ヶ月おきにリリースする予定です。
Ruby 3.4.6 は9月に、3.4.7 は11月に、3.4.8 は1月にリリースされる予定です。
