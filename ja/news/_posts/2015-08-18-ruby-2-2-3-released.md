...
このリリースには RubyGems ドメイン名検証の脆弱性についてのセキュリティフィックスが含まれています。
...
その他詳細は [ChangeLog](https://git.ruby-lang.org/ruby.git/plain/ChangeLog?id=refs/tags/v2_2_3) を参照してください。
