...
Ruby の開発に関連する文書は現在主に[Redmine(問題追跡システム)のWiki][1]に集められています。
...
また、毎日、日本時間の午前4時頃に、開発版系列(現在はruby 2.5)および安定版系列(現在はruby
2.4)のソースコードのスナップショットを作成しています。 それぞれ、以下のリンクからダウンロードできます。
