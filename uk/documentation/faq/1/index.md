...
Офіційна головна сторінка Ruby — [www.ruby-lang.org](/uk/).
...
[Документація](/uk/documentation/) і [Спільнота](/uk/community/).
...
[Поштові розсилки](/uk/community/mailing-lists/)
...
(див. [сторінку поштових розсилок](/uk/community/mailing-lists/)).
