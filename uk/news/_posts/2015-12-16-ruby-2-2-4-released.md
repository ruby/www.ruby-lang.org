...
Цей випуск включає виправлення безпеки для розширення Fiddle.
...
Див. [ChangeLog](https://git.ruby-lang.org/ruby.git/plain/ChangeLog?id=refs/tags/v2_2_4) для деталей.

## Завантаження

* [https://cache.ruby-lang.org/pub/ruby/2.2/ruby-2.2.4.tar.bz2](https://cache.ruby-lang.org/pub/ruby/2.2/ruby-2.2.4.tar.bz2)

      РОЗМІР:   13336518 байтів
