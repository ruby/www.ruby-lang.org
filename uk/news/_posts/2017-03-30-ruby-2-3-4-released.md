...
Цей випуск містить близько 80 виправлень помилок після попереднього випуску.
Див. [логи комітів](https://github.com/ruby/ruby/compare/v2_3_3...v2_3_4)
для деталей.

І цей випуск містить виправлення помилки Symbol#hash, щоб бути недетермінованим.
Це регресія в серії 2.3 до 2.3.4.
Див. [Помилка #13376](https://bugs.ruby-lang.org/issues/13376) для більше деталей.


## Відома проблема

_(Цей розділ додано 11 квітня 2017 року.)_

Було знайдено несумісність API для Ruby 2.3.4.
Це випадкове видалення функції API `rb_thread_fd_close`.
