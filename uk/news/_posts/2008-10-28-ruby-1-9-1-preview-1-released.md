---
layout: news_post
title: "Вийшов Ruby 1.9.1-preview 1"
author: "james"
translator: "Andrii Furmanets"
lang: uk
---

Yugui (Yuki Sonoda) оголосив про випуск Ruby 1.9.1-preview 1:

> Це preview випуск Ruby 1.9.1, який буде першою
> стабільною версією серії Ruby 1.9. Спробуйте його зараз та отримайте ранній
> смак сучасного, швидшого, багатомовного та значно покращеного Ruby
> з чіткішим синтаксисом.
> Якщо ви зіткнетеся з будь-якими помилками або проблемами, будь ласка, повідомте нам через
> офіційну систему відстеження проблем:
>
> [https://bugs.ruby-lang.org][1]

Ви можете завантажити випуск з:

* [https://cache.ruby-lang.org/pub/ruby/1.9/ruby-1.9.1-preview1.tar.bz2][2]
  РОЗМІР: 6169022 байтів
