...
Цей випуск включає виправлення помилки для deadlock в багатопотокових/багатопроцесних додатках (які використовують `Process.fork` з багатопотокових батьківських процесів), таких як, наприклад, Puma.

Див. [логи комітів](https://github.com/ruby/ruby/compare/v2_5_4...v2_5_5) для змін детально.

## Завантаження

* <https://cache.ruby-lang.org/pub/ruby/2.5/ruby-2.5.5.tar.bz2>

      РОЗМІР:   14165422 байтів
...
Я хочу висловити свою подяку sorah та k0kubun за їхній звіт та розслідування. Дякую.