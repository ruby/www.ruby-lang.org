...
Це перший випуск версії TEENY стабільної серії 2.3.

Є багато виправлень помилок.
Див. [ChangeLog](https://git.ruby-lang.org/ruby.git/plain/ChangeLog?id=refs/tags/v2_3_1)
для деталей.
