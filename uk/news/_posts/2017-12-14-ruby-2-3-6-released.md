...
Цей випуск включає близько 10 виправлень помилок після попереднього випуску, а також включає кілька виправлень безпеки.
