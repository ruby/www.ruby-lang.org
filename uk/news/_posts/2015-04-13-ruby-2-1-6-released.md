...
Цей випуск включає виправлення безпеки для розширення OpenSSL.
...
та [ChangeLog](https://git.ruby-lang.org/ruby.git/plain/ChangeLog?id=refs/tags/v2_1_6)
для деталей.
