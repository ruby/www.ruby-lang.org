...
Див. [ChangeLog](https://github.com/ruby/ruby/blob//v2_2_7/ChangeLog)
для деталей.

Після цього випуску ми закінчимо нормальну фазу обслуговування Ruby 2.2,
та почнемо фазу обслуговування безпеки.
Це означає, що після випуску 2.2.7 ми ніколи не будемо backport'ити жодних виправлень помилок
до 2.2, крім виправлень безпеки.
Термін фази обслуговування безпеки заплановано на 1 рік.
До кінця цього терміну офіційна підтримка Ruby 2.2 буде закінчена.
Тому ми рекомендуємо вам почати планувати оновлення до Ruby 2.4 або 2.3.
...
Обслуговування Ruby 2.2, включаючи цей випуск,
базується на "Угоді для стабільної версії Ruby"
