...
Ми раді оголосити випуск Ruby 2.0.0-p576, щоб відсвяткувати
проведення [RubyKaigi2014](http://rubykaigi.org/2014) в Японії зараз.

Цей випуск включає багато виправлень помилок, таких як:

* багато виправлень витоків пам'яті та використання зайвої пам'яті,
* багато виправлень проблем, специфічних для платформи (особливо в процесі збірки),
* багато виправлень документації.

Див. [тікети](https://bugs.ruby-lang.org/projects/ruby-200/issues?set_filter=1&amp;status_id=5)
та [ChangeLog](https://git.ruby-lang.org/ruby.git/plain/ChangeLog?id=refs/tags/v2_0_0_576) для деталей.
