...
Цей випуск включає багато інших виправлень помилок.

* Вирішено проблеми збірки на Solaris.
* Підтримка Windows 8 (сподіваємося).
* багато інших виправлень помилок.

Див. [тікети][1] та [ChangeLog][2] для деталей.

Крім того, жодних виправлень безпеки не включено в цей випуск.
...
* [&lt;URL:https://cache.ruby-lang.org/pub/ruby/1.9/ruby-1.9.3-p362.zip&gt;][5]
  * РОЗМІР: 13869324 байтів
  * MD5: 764d5e2d8149a7f424fc02089f8a7359
  * SHA256: 713ed8149f819ef3ae6b9ac0e27d0c9ee26d3d78e44d42d02ce426d6cb18068d

## Коментар до випуску

Багато комітерів та користувачів, які надали звіти про помилки, значно допомогли мені зробити
цей випуск. Дякую всім.

Щасливих свят, і щасливого хакінгу!
