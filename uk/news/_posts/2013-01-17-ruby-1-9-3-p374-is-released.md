---
layout: news_post
title: "Вийшов Ruby 1.9.3-p374"
author: "usa"
translator: "Andrii Furmanets"
lang: uk
---

Тепер Ruby 1.9.3-p374 випущено.

Цей випуск включає багато виправлень помилок. Особливо,

* Виправлено випадкову проблему SEGV (часто повідомляється з Rails)
* Підтримка Windows 8 (можливо, сподіваємося)
* багато інших виправлень помилок.

Див. [тікети][1] та [ChangeLog][2] для деталей.

Жодних нових виправлень безпеки не включено в цей випуск, але я рекомендую
користувачам попереднього випуску (p362) оновитися.
...
* [&lt;URL:https://cache.ruby-lang.org/pub/ruby/1.9/ruby-1.9.3-p374.zip&gt;][5]
  * РОЗМІР: 13871394 байтів
  * MD5: c0001d5d36ad2e3e6a84810abe585b79
  * SHA256: 058af4cf409c93cce1de74a6b3355ddcf740f3efae1ab02d63471fcdbed19088

## Коментар до випуску

Багато комітерів, тестувальників та користувачів, які надали звіти про помилки, значно допомогли
мені зробити цей випуск. Дякую всім.
