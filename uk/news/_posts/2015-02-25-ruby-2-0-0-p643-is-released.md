...
Ми раді оголосити випуск Ruby 2.0.0-p643.

Це останній звичайний випуск Ruby 2.0.0.
Ruby 2.0.0 переходить у стан фази обслуговування безпеки,
...
Потім обслуговування Ruby 2.0.0 буде закінчено 24 лютого 2016 року.
Ми рекомендуємо почати планувати міграцію до новіших версій Ruby, таких як 2.1 або 2.2.
...
та [ChangeLog](https://github.com/ruby/ruby/blob//v2_0_0_643/ChangeLog)
для деталей.
...
Дякую всім, хто допоміг з цим та попередніми випусками.
