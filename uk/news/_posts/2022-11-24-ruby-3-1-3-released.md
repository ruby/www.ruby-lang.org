...
Цей випуск також включає виправлення збою збірки з Xcode 14 та macOS 13 (Ventura).
Див. [пов'язаний тікет](https://bugs.ruby-lang.org/issues/18912) для більше деталей.

Див. [GitHub releases](https://github.com/ruby/ruby/releases/tag/v3_1_3) для подальших деталей.
