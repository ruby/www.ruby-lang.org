...
в [попередньому випуску](https://www.ruby-lang.org/uk/news/2014/10/27/ruby-2-1-4-released/),
але новий та відрізняється від неї.
...
та [ChangeLog](https://git.ruby-lang.org/ruby.git/plain/ChangeLog?id=refs/tags/v2_1_5)
для деталей.
...
Дякую всім, хто надав співпрацю для випуску.
