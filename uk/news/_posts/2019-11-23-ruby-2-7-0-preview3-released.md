---
layout: news_post
title: "Вийшов Ruby 2.7.0-preview3"
author: "naruse"
...
Preview версія випущена для збору відгуків для фінального випуску,
запланованого на грудень.
Цей preview3 в основному випущено для підтвердження сумісності
ключових аргументів.
...
* ~~`Symbol#to_s`~~ (відкочено назад), `Module#name`, `true.to_s`, `false.to_s`,
...
3895 файлів змінено, 213426 додано(+), 96934 видалено(-)

Див. [NEWS](https://github.com/ruby/ruby/blob/v2_7_0_preview3/NEWS)
або [логи комітів](https://github.com/ruby/ruby/compare/v2_6_0...v2_7_0_preview3)
для більше деталей.
