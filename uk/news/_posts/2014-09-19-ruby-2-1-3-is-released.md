...
Ми раді оголосити випуск Ruby 2.1.3.
Це випуск рівня патчу стабільної серії 2.1.

Цей випуск містить зміну часу повного GC для зменшення споживання пам'яті
...
та [ChangeLog](https://github.com/ruby/ruby/blob//v2_1_3/ChangeLog)
для деталей.
