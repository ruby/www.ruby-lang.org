---
layout: news_post
title: "Вийшли Ruby 1.8.7-p72 та 1.8.6-p287"
author: "Shugo Maeda"
translator: "Andrii Furmanets"
lang: uk
---

Ruby 1.8.7-p72 та 1.8.6-p287 випущено. Останні випуски були
неповними, і нові випуски включають виправлення [раніше
оголошеної вразливості dl][1].

Випущені архіви вихідного коду доступні на:
...
Для повного списку всіх змін, див. включені файли з назвою ChangeLog,
які також доступні за наступними адресами:
...
[1]: {{ site.url }}/uk/news/2008/08/08/multiple-vulnerabilities-in-ruby/#label-3
