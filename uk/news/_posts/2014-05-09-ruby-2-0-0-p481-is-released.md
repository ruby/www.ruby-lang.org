...
Ми раді оголосити випуск Ruby 2.0.0-p481.

Цей випуск включає багато виправлень помилок, таких як:

* підтримка збірки з Readline-6.3,
* виправлення для старого OpenSSL (регресія в p451),
* оновлена включена версія libyaml
...
та [ChangeLog](https://git.ruby-lang.org/ruby.git/plain/ChangeLog?id=refs/tags/v2_0_0_481) для деталей.
