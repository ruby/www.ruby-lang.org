...
Ми раді оголосити випуск Ruby 2.0.0-p645.
...
Цей випуск включає виправлення безпеки, згадане вище, разом з невеликими змінами, необхідними для тестового середовища (що не повинно впливати на звичайних користувачів).

Див. [ChangeLog](https://git.ruby-lang.org/ruby.git/plain/ChangeLog?id=refs/tags/v2_0_0_645) для повних деталей.
...
Дякую всім, хто допоміг з цим випуском, особливо, zzak.
