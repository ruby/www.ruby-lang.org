...
ПРИМІТКА: Занадто багато попереджень про застарілість про несумісності ключових аргументів
...
* Нумеровані параметри як параметри блоку за замовчуванням введено
...
* Виклик приватного методу з літералом `self` як отримувачем
  тепер дозволено.
...
* `lambda` без блоку в методі, викликаному з блоком, піднімає виняток.
...
Див. [NEWS](https://github.com/ruby/ruby/blob/v2_7_0_rc2/NEWS)
або [логи комітів](https://github.com/ruby/ruby/compare/v2_6_0...v2_7_0_rc2)
для більше деталей.

З цими змінами, [{{ release.stats.files_changed }} файлів змінено, {{ release.stats.insertions }} додано(+), {{ release.stats.deletions }} видалено(-)](https://github.com/ruby/ruby/compare/v2_6_0...v2_7_0_rc2)
з Ruby 2.6.0!
