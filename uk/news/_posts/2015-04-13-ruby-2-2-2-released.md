...
Ми раді оголосити випуск Ruby 2.2.2.
Це випуск версії TEENY стабільної серії 2.2.

Цей випуск включає виправлення безпеки для вразливості перевірки імені хоста розширення OpenSSL.
...
Див. [ChangeLog](https://github.com/ruby/ruby/blob//v2_2_2/ChangeLog)
для деталей.
