---
layout: news_post
title: "Вийшов Ruby 3.3.0-preview3"
author: "naruse"
...
* Опція вимкнення code GC та розглядання `--yjit-exec-mem-size` як жорсткої межі
  * Може створювати кращу поведінку copy-on-write на серверах, що використовують unicorn та форкінг
...
* Змінна середовища `RUBY_GC_HEAP_REMEMBERED_WB_UNPROTECTED_OBJECTS_LIMIT_RATIO` додано. [Feature #19571](https://bugs.ruby-lang.org/issues/19571)
* Діти старих об'єктів більше не одразу підвищуються до старого покоління в збирачі сміття. [Feature #19678](https://bugs.ruby-lang.org/issues/19678)
