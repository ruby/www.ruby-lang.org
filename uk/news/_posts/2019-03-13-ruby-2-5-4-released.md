...
Цей випуск включає виправлення помилок та оновлення безпеки включеного RubyGems.
Див. деталі в [Множинні вразливості в RubyGems](/uk/news/2019/03/05/multiple-vulnerabilities-in-rubygems/)
та [логи комітів](https://github.com/ruby/ruby/compare/v2_5_3...v2_5_4).

## Завантаження

* <https://cache.ruby-lang.org/pub/ruby/2.5/ruby-2.5.4.tar.bz2>

      РОЗМІР:   14167366 байтів
