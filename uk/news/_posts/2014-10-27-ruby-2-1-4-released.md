...
Цей випуск включає виправлення безпеки для наступних вразливостей:

* [CVE-2014-8080: Відмова в обслуговуванні розширення XML](https://www.ruby-lang.org/uk/news/2014/10/27/rexml-dos-cve-2014-8080/)
* [Змінено налаштування за замовчуванням ext/openssl, пов'язані з CVE-2014-3566](https://www.ruby-lang.org/uk/news/2014/10/27/changing-default-settings-of-ext-openssl/)

І є деякі виправлення помилок.

Див. [тікети](https://bugs.ruby-lang.org/projects/ruby-21/issues?set_filter=1&amp;status_id=5)
та [ChangeLog](https://git.ruby-lang.org/ruby.git/plain/ChangeLog?id=refs/tags/v2_1_4)
для деталей.
