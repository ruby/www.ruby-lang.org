---
layout: news_post
title: "Ruby 2.7.0-rc2 đã được phát hành"
author: "naruse"
translator:
...
Chúng tôi vui mừng thông báo phiên bản Ruby 2.7.0-rc2 đã được phát hành.

Một bản release candidate được phát hành để thu thập phản hồi cho bản phát hành
chính thức dự kiến vào ngày 25 tháng 12.
...
Xem [NEWS](https://github.com/ruby/ruby/blob/v2_7_0_rc2/NEWS)
hoặc [nhật ký commit](https://github.com/ruby/ruby/compare/v2_6_0...v2_7_0_rc2)
để biết thêm chi tiết.

Với những thay đổi đó, [{{ release.stats.files_changed }} tệp đã thay đổi, {{ release.stats.insertions }} thêm vào(+), {{ release.stats.deletions }} xóa đi(-)](https://github.com/ruby/ruby/compare/v2_6_0...v2_7_0_rc2)
kể từ Ruby 2.6.0!
