...
Như đã nói trước đây, chúng tôi phát hành nếu có một sự thối lui nghiêm trọng được tìm thấy.

Một số người dùng đã báo cáo những vấn đề trong môi trường sử dụng phiên bản cũ của OpenSSL, chẳng hạn hệ điều hành Ubuntu 10.04 LTS.
Đây là một sự thối lui đã được giới thiệu trong Ruby 1.9.3-p545.
