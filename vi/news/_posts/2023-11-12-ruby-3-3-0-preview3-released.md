---
layout: news_post
title: "Ruby 3.3.0-preview3 đã được phát hành"
author: "naruse"
translator:
...
* Tùy chọn tắt code GC và coi `--yjit-exec-mem-size` là giới hạn cứng
  * Có thể tạo hành vi copy-on-write tốt hơn trên các máy chủ sử dụng unicorn và forking
...
* Biến môi trường `RUBY_GC_HEAP_REMEMBERED_WB_UNPROTECTED_OBJECTS_LIMIT_RATIO` đã được thêm vào. [Feature #19571](https://bugs.ruby-lang.org/issues/19571)
* Các đối tượng con của các đối tượng cũ không còn được thăng cấp ngay lập tức lên thế hệ cũ trong bộ thu gom rác. [Feature #19678](https://bugs.ruby-lang.org/issues/19678)
