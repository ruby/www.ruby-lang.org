...
Ruby 3.4.8 đã được phát hành.

Đây là bản cập nhật định kỳ bao gồm các bản sửa lỗi.
Vui lòng tham khảo [ghi chú phát hành trên GitHub](https://github.com/ruby/ruby/releases/tag/v3_4_8) để biết thêm chi tiết.
...
Ruby 3.4.9 dự kiến phát hành vào tháng 2.
