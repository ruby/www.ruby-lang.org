...
Ruby 3.4.2 đã được phát hành.

Đây là bản cập nhật định kỳ bao gồm các bản sửa lỗi. Vui lòng tham khảo
[ghi chú phát hành trên GitHub](https://github.com/ruby/ruby/releases/tag/v3_4_2) để biết thêm chi tiết.

## Lịch trình phát hành

Chúng tôi dự định phát hành phiên bản Ruby ổn định mới nhất (hiện tại là Ruby 3.4) mỗi 2 tháng.
Ruby 3.4.3 sẽ được phát hành vào tháng 4, 3.4.4 vào tháng 6, 3.4.5 vào tháng 8, 3.4.6 vào tháng 10, và 3.4.7 vào tháng 12.
